...
const checks=[
  ...
  [html.includes('OmniHub Solutions Portal v2.7.6'),'portal release version'],
...
console.log('Portal v2.7.6 management, printer selection, deletion, CRM, and quotation validation passed.');
