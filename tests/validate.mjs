...
const checks=[
  ...
  [html.includes('OmniHub Solutions Portal v2.7.8'),'portal release version'],
...
console.log('Portal v2.7.8 management, printer selection, deletion, CRM, and quotation validation passed.');
